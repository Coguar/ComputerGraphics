...
{
	// ¬ключаем источник света с заданным индексом.
	// »сточник действует только когда включен режим GL_LIGHTING!
...
// не мен€ем w-компоненту вектора (по-прежнему 0)
...
{
	SetupImpl();
	// ≈сли GL_POSITION установить как (x, y, z, 0), т.е. как вектор
...
{
	SetupImpl();
	// ≈сли GL_POSITION установить как (x, y, z, 1), т.е. как точку
