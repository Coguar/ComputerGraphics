...
//vec3 norm =
	...
	vec3 v1  = vec3(torCoor.x, torCoor.y, torCoor.z) - vec3(torCoor1.x, torCoor1.y, torCoor1.z);
	vec3 v2 = vec3(torCoor2.x, torCoor2.y, torCoor2.z) - vec3(torCoor1.x, torCoor1.y, torCoor1.z);
